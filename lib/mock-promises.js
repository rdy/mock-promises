    ...
    execute: function() {
      if(!this._executed) {
        ...
        if(this.promise.isFulfilled()) {
          value = isFunction(this.promise.value) ? this.promise.value() : this.promise.inspect().value;
          ...
          value = isFunction(this.promise.reason) ? this.promise.reason() : this.promise.inspect().reason;
